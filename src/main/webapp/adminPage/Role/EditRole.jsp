		...
		<div class="layout-container">
			...
			<div class="layout-page">
				...
				<div style="padding: 0px 30px;">
					...
					<form action="${pageContext.request.contextPath}/RoleController?action=editsubmit" method="post">
					<input type="hidden" name="roleId" value="${roleDetail.roleId}">
						<div class="pb-3">
							<label class="form-label">Tên</label> <input
								value="${roleDetail.rolename}" name="rolename" type="text"
								class="form-control">
						</div>

						<div class="pb-3">
							<label class="form-label">Mô tả</label> <input
								value="${roleDetail.description}" name="description" type="text"
								class="form-control">
						</div>
