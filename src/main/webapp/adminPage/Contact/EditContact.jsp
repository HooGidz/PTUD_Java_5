		...
		<div class="layout-container">
			...
			<div class="layout-page">
				...
				<div style="padding: 0px 30px;">
					...
					<form action="${pageContext.request.contextPath}/Contact?action=editsubmit" method="post">
					<input type="hidden" name="contatcId" value="${contactDetail.contatcId}">
						<div class="pb-3">
							<label class="form-label">Tên</label> <input
								value="${contactDetail.name}" name="name" type="text"
								class="form-control">
						</div>

						<div class="pb-3">
							<label class="form-label">Tin nhắn</label> <input
								value="${contactDetail.message}" name="message" type="text"
								class="form-control">
						</div>
						<div class="pb-3">
