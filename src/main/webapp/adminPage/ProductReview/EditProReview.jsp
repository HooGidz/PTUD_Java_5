		...
		<div class="layout-container">
			...
			<div class="layout-page">
				...
				<div style="padding: 0px 30px;">
					...
					<form action="ProductReview?action=editsubmit" method="post">
						<input type="hidden" name="reviewId" value="${reviewDetail.productReviewId}">


						<div class="pb-3">
							<label class="form-label">Trạng thái</label> <select
								name="isActive" class="form-select">
								<option value="1" ${reviewDetail.active ? "selected" : ""}>Hiển
									thị</option>
								<option value="0" ${!reviewDetail.active ? "selected" : ""}>Ẩn</option>
							</select>
						</div>
						<button type="submit" class="btn btn-primary mt-3">Cập
							nhật trạng thái</button>
						<button type="button" onclick="history.back()"
							class="btn btn-secondary mt-3">Quay lại</button>
					</form>
