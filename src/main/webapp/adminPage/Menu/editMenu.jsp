		...
		<div class="layout-container">
			...
			<div class="layout-page">
				...
				<div style="padding: 0px 30px;">
					<form action="${pageContext.request.contextPath}/MenuController?action=editsubmit" method="post">
						<input type="hidden" name="id" value="${menuDetail.menuId}">

						<div class="pb-3">
							<label class="form-label">Tên</label> <input
								value="${menuDetail.name}" name="name" type="text"
								class="form-control">
						</div>

						<div class="pb-3">
							<label class="form-label">Alias</label> <input
								value="${menuDetail.alias}" name="alias" type="text"
								class="form-control">
						</div>

						<div class="pb-3">
							<label class="form-label">Mô tả</label> <input
								value="${menuDetail.description}" name="description" type="text"
								class="form-control">
						</div>

						<div class="pb-3">
							<label class="form-label">Cấp</label> <input
								value="${menuDetail.position}" name="position" type="text"
								class="form-control">
						</div>
