		...
		<div class="layout-container">
			...
			<div class="layout-page">
				...
				<div style="padding: 0px 30px;">
					...
					<form action="MenuController?action=addsubmit" method="post">
						<div class="pb-3">
							<label for="inputName" class="form-label">Tên</label> <input
								name="name" type="text" class="form-control" id="inputName"
								placeholder="Tên" aria-describedby="defaultFormControlHelp">
						</div>
						<div class="pb-3">
							<label for="inputAlias" class="form-label">Alias </label> <input
								name="alias" type="text" class="form-control" id="inputAlias"
								placeholder="" aria-describedby="defaultFormControlHelp">
						</div>
						<div class="pb-3">
							<label for="inputDescription" class="form-label">Mô tả </label> <input
								name="description" type="text" class="form-control"
								id="inputDescription" placeholder="Mô tả"
								aria-describedby="defaultFormControlHelp">
						</div>
						<div class="pb-3">
							<label for="inputPosition" class="form-label">Cấp</label> <input
								name="position" type="text" class="form-control"
								id="inputPosition" placeholder="Cấp"
								aria-describedby="defaultFormControlHelp">
						</div>
						<div class="pb-3">
							<label for="inputCreateddate" class="form-label">Ngày tạo
							</label> <input name="createddate" type="text" class="form-control"
								id="inputCreateddate" placeholder="ngày tạo"
								aria-describedby="defaultFormControlHelp">
						</div>
						<div class="pb-3">
							<label for="inputCreatedby" class="form-label">Người tạo
							</label> <input name="createdby" type="text" class="form-control"
								id="inputCreatedby" placeholder="ngày sửa"
								aria-describedby="defaultFormControlHelp">
						</div>
						<div class="pb-3">
							<label for="inputModifieddate" class="form-label">Ngày
								sửa </label> <input name="modifieddate" type="text" class="form-control"
								id="inputModifieddate" placeholder="người sửa"
								aria-describedby="defaultFormControlHelp">
						</div>
						<div class="pb-3">
							<label for="inputModifiedby" class="form-label">Người sửa
							</label> <input name="modifiedby" type="text" class="form-control"
								id="inputModifiedby" placeholder="người sửa"
								aria-describedby="defaultFormControlHelp">
						</div>
						<div class="pb-3">
							<label for="inputIsactive" class="form-label">Hoạt động </label>
							<input name="isactive" type="text" class="form-control"
								value="True" id="inputIsactive" placeholder="người sửa"
								aria-describedby="defaultFormControlHelp">
						</div>
						<div class="pb-3">
							<label for="inputIsdropdown" class="form-label">Hiện thị
							</label> <input name="isdropdown" type="text" class="form-control"
								value="True" id="inputIsdropdown" placeholder="người sửa"
								aria-describedby="defaultFormControlHelp">
						</div>
