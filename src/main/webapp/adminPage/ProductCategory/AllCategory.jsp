		...
		<div class="layout-container">
			...
			<div class="layout-page">
				...
				<div class="p-4">
					...
					<a href="ProductCategory?action=add">
				...
				<div class="table-responsive text-nowrap">
					<table class="table">
						...
						<tbody class="table-border-bottom-0">
							<c:forEach items="${listCategory}" var="o" varStatus="status">
								<tr>
									<td>${status.count}</td>
									<td><strong>${o.name}</strong></td>
									<td>${o.roomCategoryId}</td>
									<td>${o.description}</td>
									<c:if test="${o.active}">
									...
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu">
												<a href="ProductCategory?action=edit&id=${o.categoryId}" class="dropdown-item">
													<i class="bx bx-edit-alt me-1"></i> Sửa
												</a>
												<a onclick="return confirm('Bạn có chắc chắn muốn xoá?')"
												   href="ProductCategory?action=delete&id=${o.categoryId}"
												   class="dropdown-item">
