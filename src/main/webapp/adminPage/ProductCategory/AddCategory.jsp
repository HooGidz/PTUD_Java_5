		...
		<div class="layout-container">
			...
			<div class="layout-page">
				...
				<div style="padding: 0px 30px;">
					...
					<form action="ProductCategory?action=addsubmit" method="post">
						<div class="pb-3">
						...
						<div class="pb-3">
							...
							<input name="roomCategoryId" type="number" class="form-control"
								placeholder="ID danh mục phòng" required>
						</div>
