	...
	<div class="layout-wrapper layout-content-navbar">
		<div class="layout-container">
			...
			<div class="layout-page">
				...
				<div class="p-2">
					<h1>Sửa thông tin danh mục phòng</h1>
				</div>
				<div style="padding: 0px 30px;">

					<form action="RoomCategory?action=editsubmit" method="post">
						<input type="hidden" name="roomCategoryId" value="${roomCate.roomCategoryId}">

						<div class="pb-3">
							<label class="form-label">Tên danh mục phòng</label>
							<input value="${roomCate.name }" name="name" type="text" class="form-control" required>
						</div>

						<div class="pb-3">
							<label class="form-label">Alias</label>
							<input value="${roomCate.alias }" name="alias" type="text" class="form-control" required>
						</div>

						<div class="pb-3">
							<label class="form-label">Mô tả</label>
							<textarea name="description" class="form-control" rows="2">${roomCate.description }</textarea>
						</div>

						<div class="pb-3">
    <label class="form-label">Trạng thái</label>
    <select name="isActive" class="form-select">
        <option value="1" ${roomCate.active ? "selected" : ""}>Hiển thị</option>
        <option value="0" ${!roomCate.active ? "selected" : ""}>Ẩn</option>
    </select>
</div>
