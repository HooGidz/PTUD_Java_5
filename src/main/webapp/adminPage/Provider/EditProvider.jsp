		...
		<div class="layout-container">
			...
			<div class="layout-page">
				...
				<div style="padding: 0px 30px;">
					<form action="Provider?action=editsubmit" method="post">
					<input type="hidden" name="id" value="${providerDetail.providerId }">
						<div class="pb-3">
							<label for="defaultFormControlInput" class="form-label">Tên
								nhà cung cấp</label> <input value="${providerDetail.providerName }"
								name="name" type="text" class="form-control"
								id="defaultFormControlInput" placeholder="Tên danh mục"
								aria-describedby="defaultFormControlHelp">
						</div>
						<div class="pb-3">
							<label for="defaultFormControlInput" class="form-label">Địa
								chỉ</label> <input value="${providerDetail.address }" name="address"
								type="text" class="form-control" id="defaultFormControlInput"
								placeholder="Địa chỉ" aria-describedby="defaultFormControlHelp">
						</div>
						<div class="pb-3">
							<label for="defaultFormControlInput" class="form-label">Số
								điện thoại</label> <input value="${providerDetail.phone }" name="phone"
								type="text" class="form-control" id="defaultFormControlInput"
						...
						<div class="pb-3">
							...
							<input value="${providerDetail.email }" name="email" type="text"
								class="form-control" id="defaultFormControlInput"
								placeholder="Email" aria-describedby="defaultFormControlHelp">
						</div>
						<div class="pb-3">
							<label for="defaultFormControlInput" class="form-label">Mô
								tả</label>
							<textarea name="description" class="form-control"
								id="exampleFormControlTextarea1" rows="2">${providerDetail.description }</textarea>
						</div>
						<div>
							<label for="defaultFormControlInput" class="form-label">Trạng
								thái</label> <select name="status" id="defaultSelect"
								class="form-select">

								<c:choose>
									<c:when test="${providerDetail.status}">
