		...
		<div class="layout-container">
			...
			<div class="layout-page">
				...
				<div style="padding: 0px 30px;">
					...
					<form action="AccountController?action=addsubmit" method="post">

						<div class="pb-3">
							<label for="inputUsername" class="form-label">Tên đăng
								nhập (*)</label> <input name="username" type="text" class="form-control"
								id="inputUsername" placeholder="Ví dụ: user.login123" required
								aria-describedby="usernameHelp">
						</div>

						<div class="pb-3">
							<label for="inputPassword" class="form-label">Mật khẩu
								(*)</label> <input name="password" type="password" class="form-control"
								id="inputPassword" placeholder="Nhập mật khẩu" required
						...
						<div class="pb-3">
							<label for="inputFullName" class="form-label">Họ và Tên</label> <input
								...
								id="inputFullName" placeholder="Nguyễn Văn A"
								aria-describedby="fullnameHelp">
						</div>

						<div class="pb-3">
							<label for="inputPhone" class="form-label">Điện thoại</label> <input
								name="phone" type="tel" class="form-control" id="inputPhone"
								placeholder="090xxxxxxx" aria-describedby="phoneHelp">
						</div>
						...
						<div class="pb-3">
							<label for="inputBirthday" class="form-label">Ngày sinh</label> <input
								name="birthday" type="date" class="form-control"
								id="inputBirthday" aria-describedby="birthdayHelp">
						</div>

						<div class="pb-3">
							<label for="inputAvatar" class="form-label">Avatar (URL)</label>
							<input name="avatar" type="text" class="form-control"
								id="inputAvatar" placeholder="Link ảnh đại diện"
								aria-describedby="avatarHelp">
						</div>

						<div class="pb-3">
							<label for="inputRoleID" class="form-label">ID Quyền (*)</label>
							<input name="roleID" type="number" class="form-control"
								id="inputRoleID" placeholder="Ví dụ: 1 (Admin) hoặc 2 (User)"
								required aria-describedby="roleIDHelp" min="1">
						</div>

						<div class="pb-3 form-check">
							<input name="isActive" type="checkbox" class="form-check-input"
								id="inputIsactive" checked> <label for="inputIsactive"
								class="form-check-label">Hoạt động (Kích hoạt tài khoản)</label>
						</div>
