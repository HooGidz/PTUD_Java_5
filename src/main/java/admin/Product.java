...
public class Product extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (action.equals("addsubmit")) {
			...
			tbl_Product p = new tbl_Product(0, providerId, categoryId, name, alias, brands, material, dimensions,
			...
			dao.editProduct(productId, providerId, categoryId, name, alias, brands, material, dimensions, description,
					detail, image, price, priceSale, quantity, isBestSeller, isActive, star);
