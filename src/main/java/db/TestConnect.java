...
public class TestConnect {
	...
	/*
	 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * THÔNG TIN KẾT NỐI (Sử
	 * dụng SQL Server Authentication) * * * * * * * * * * * * * * * * * * * * * * *
	 * * * * * *
	 */
	...
	public void testDatabaseConnection() {
		...
		try {
			...
			if (conn != null) {
				...
				if (rs.next()) {
					System.out.println("    Đọc dữ liệu thành công! (Thời gian hiện tại trên DB: "
			...
			System.err.println(
					"❌ LỖI SQL: Kết nối thất bại. Kiểm tra lại thông tin đăng nhập và trạng thái của SQL Server.");
			e.printStackTrace();
		} catch (Exception e) {
